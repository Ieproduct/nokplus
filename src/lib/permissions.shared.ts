export const PERMISSION_KEYS = [
  ...
  "gr.view", "gr.create", "gr.edit", "gr.confirm",
...
export const PERMISSION_LABELS: Record<PermissionKey, string> = {
  ...
  "gr.view": "ดูใบรับสินค้า",
  "gr.create": "สร้างใบรับสินค้า",
  "gr.edit": "แก้ไขใบรับสินค้า",
  "gr.confirm": "ยืนยันใบรับสินค้า",
...
export const PERMISSION_GROUPS: { label: string; keys: PermissionKey[] }[] = [
  ...
  { label: "ใบรับสินค้า (GR)", keys: ["gr.view", "gr.create", "gr.edit", "gr.confirm"] },
